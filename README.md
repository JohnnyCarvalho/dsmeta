...
```
Este é um projeto que tem como objetivo criar uma aplicação completa, há qual, terá
uma funcionalidade de envio de SMS utilizando o serviço Twilio, esse projeto 
será implementado desde sua criação até a hospedagem na nuvem utilizando o 
Heroku para a hospedagem Back end e o Netlify para o Front End.
```
## ETAPA 1
...
```
### Passo 2: criar projeto Spring Boot
...
### Passo 3: "limpar" o projeto ReactJS

```
Nessa etapa vamos excluir algumas pastas que vem nativo 
no projeto react quando criado.
```

### Passo 4: Criando os componentes no React

```
Agora vamos criar os componentes do nosso projeto, vamos criar os seguintes compinentes:
NotificationButton que será o componente do nosso botão de envio de SMS, SalesCard que será 
o componente da nossa página principal e o Header que será o componente da nossa logo e do cabeçalho da pagina.
```

### Passo 5: Datepicker

- Instalando a bibliotéca Datepicker para representar a data.
...
### Passo 3: Primeiro teste de endpoint da API REST

- Criar repository
- Criar service
- Criar controller

### Passo 4: Consulta por data
...
## Passo 1: Primeira requisição com Axios e useEffect
...
## Passo 3: Passando as datas como argumento

## Passo 4: Enviar notificação

## Passo 5: Mensagem Toast de confirmação
